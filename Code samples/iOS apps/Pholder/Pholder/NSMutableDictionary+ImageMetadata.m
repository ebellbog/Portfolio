...
//  Modified and extended by Elana Bogdan, November 2014
//
...
- (NSArray *)getKeywords {
   return IPTC_DICT[(NSString*)kCGImagePropertyIPTCKeywords];
}

- (void)addKeywords:(NSArray *)keywords {
   NSMutableSet *keywordSet = [NSMutableSet setWithArray:self.getKeywords];
   [keywordSet addObjectsFromArray:keywords];
   
   [self setKeywords:keywordSet.allObjects];
}
